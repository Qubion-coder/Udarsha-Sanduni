      ...
      <div className="text-center mb-16 sm:mb-24 relative z-10">
        ...
        >
          ...
          <h2 className="text-5xl sm:text-7xl font-names text-stone-800 tracking-tight drop-shadow-sm">
            Udarsha <span className="text-brand-plum font-light mx-2">&</span> Sanduni
          </h2>
        </motion.div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-8 relative z-10">
        ...
        >
          <div className="mb-4 flex flex-col items-center lg:items-end">
            ...
            <h3 className="text-4xl sm:text-5xl font-names text-stone-800 mb-2 drop-shadow-sm">Udarsha</h3>
            <p className="text-stone-700 font-century text-xs mb-2"></p>
            <p className="text-stone-500/90 font-serif italic text-base sm:text-lg">Son of Mr. & Mrs. Prashan De Silva</p>
          </div>
        ...
        >
          <div className="mb-4 flex flex-col items-center lg:items-start">
            ...
            <h3 className="text-4xl sm:text-5xl font-names text-stone-800 mb-2 drop-shadow-sm">Sanduni</h3>
            <p className="text-stone-700 font-century text-xs mb-2"></p>
            <p className="text-stone-500/90 font-serif italic text-base sm:text-lg">Daughter of Mr. & Mrs. Samantha Fernando</p>
          </div>
